...
*}
{if $isShopgateOrder}
    <link rel="stylesheet" type="text/css" href="{$mod_dir|escape:"html":'UTF-8'}views/css/{$orderCss|escape:'html'}">
    {if $requireJs}
                                            ...
                                            <div class="col-xs-10 form-value">
                                                {if ($old_shop_version)}
                                                    {if $apiOrder->getIsShippingBlocked()}
                                                        <img src="{$image_enabled|escape:'html':'UTF-8'}">
                                                    {else}
                                                        <img src="{$image_disabled|escape:'html':'UTF-8'}">
                                                    {/if}
                                                {else}
                                                    {if $apiOrder->getIsShippingBlocked()}
